...
function openKCFinder(field, type) {
    ...
    window.open(BASE_URL + 'plugin/ckfinder/browse.php?type='+type+'&dir=images/public', 'kcfinder_image',
...
function openKCFinderDescExtend(object) {
	window.KCFinder = {
	 ...
	 window.open(BASE_URL + 'plugin/ckfinder/browse.php?type=images&dir=images/public', 'kcfinder_image',
        'status=0, toolbar=0, location=0, menubar=0, directories=0, ' +
...
function openKCFinderImage(button) {
	...
	window.open(BASE_URL + 'plugin/ckfinder/ckfinder.html?popup=1&configId=popup-1-config', 'CKFinderPopup1', popupWindowOptions
    );
}
