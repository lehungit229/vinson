                                ...
                                <div class="extend-option">
                                    <div class="option-1">
                                        <div class="uk-flex uk-flex-middle check">
                                            ...
                                            <span class="lb-title">Yêu cầu META xuất hóa đơn VAT cho công ty hoặc tổ chức</span>
                                        </div>
                                ...
                                <div class="inner-option">
                                    <div class="option-2">
                                        <div class="uk-flex uk-flex-middle check">
                                            ...
                                            <span class="lb-title">Muốn thỏa thuận với META nhân viên chúng tôi sẽ gọi cho quý khách</span>
                                        </div>
                                    </div>
                                    <div class="option-2">
                                        <div class="uk-flex uk-flex-middle check">
                        ...
                        <section class="list-money">
                            <div class="uk-grid uk-grid-small mb10">
                                <div class="uk-width-2-5">
                                    <button class="return-home mb15"><a href="<?php echo site_url() ?>">Chọn thêm sản phẩm khác</a></button>
