...
<head>
    ...
    <title>ANH MINH CMS | Đăng nhập</title>
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-6 company-infomation">
                <h2 class="font-bold">ANH MINH CMS SYSTEM V.1.0+</h2>
                <p>
                    +5,000 doanh nghiệp và chủ shop đã chọn để bán hàng từ Online đến Offline.
                </p>
                <p>
                    Sản phẩm của ANH MINH Việt Nam luôn có tốc độ xử lý rất nhanh(~2 giây) giúp đem lại trải nghiệm tốt cho người dùng.
                </p>
                <p>
            ...
            <div class="col-md-6">
                ...
                <div class="ibox-content loading otp-email">
                    ...
                    <p class="m-t">
                        <small>Hệ thống quản trị nội dung ANH MINH VIỆT NAM <?php echo date("Y"); ?> Version 1.0+</small>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                Copyright ANH MINH VIỆT NAM Company
            </div>
