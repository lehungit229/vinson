...
class Article extends MY_Controller {
	...
	public function view($id = 0){
		...
		$detailArticle = $this->Autoload_Model->_get_where(array(
			'select' => 'id, title, slug, canonical, catalogueid, description, image, viewed, (SELECT fullname FROM user WHERE user.id = article.userid_created) as fullname, created, meta_title, meta_description',
			'table' => 'article',
