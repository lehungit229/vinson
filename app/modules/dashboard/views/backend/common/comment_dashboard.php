	...
	<div class="ibox-content" style="position:relative; display: none;">
		<div class="block-comment">
			...
			<ul class="list-comment uk-list uk-clearfix">
				...
				<div class="loadmore-cmt"><a href="" title="" class="btn-loadmore" data-module="<?php echo $module;?>" data-detailid="<?php echo $detailid;?>" data-start="1" data-limit="5" data-total="<?php echo $statisticalRating['totalComment']?>">Xem thêm</a></div>
			<?php }else{?>
