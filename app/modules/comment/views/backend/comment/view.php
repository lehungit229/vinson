							...
							<div class="mb15">
								<div class="uk-flex uk-flex-middle uk-flex-space-between">
									<div class="wrap-select">
										<?php echo form_dropdown('perpage', $this->myconstant->list_data('perpage'), set_value('perpage', $this->input->get('perpage')), 'class="form-control filter" id="perpage"');?>
									</div>
									<div class="uk-flex uk-flex-middle uk-flex-right">
										<div class="uk-search uk-flex uk-flex-middle ">
											<div class="form-row wrap-select module-filter mr10">
											...
											<input type="search" name="keyword"  class="keyword form-control input-sm filter mr10" placeholder="Nhập từ khóa tìm kiếm ..." autocomplete="off" value="<?php echo $this->input->get('keyword'); ?>" >
											<input type="submit" class="btn btn-success btn-sm mr10" value="Tìm kiếm" style="margin-bottom: 0px">
										</div>
										<div class="uk-button">
